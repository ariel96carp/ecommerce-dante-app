module.exports = [
    {
        ...
        to give heritage silhouettes an energetic new form. Modeled off retro football jerseys, the Adicolor 70s \
        Vintage Cali Tee embodies the sartorial freedom of decades past with its bold color palette and 3-Stripes \
        gliding down the arms. Cut for a slim fit, the shirt is made from super-soft jersey and detailed with \
        premium rib at the collar and sleeves for modern appeal."
    },
    {
        id: "DFSF",
        name: "Cali T-Shirts",
    ...
    },
    {
        ...
        url: "n3.jpg",
        type: "arrived",
        description: "You'd be right to think that this adidas t-shirt has a completely retro look to it. It's because \
        its inspiration comes straight form the archives. A celebration of the iconic Trefoil, a swirling collage of \
        them takes over, complemented by vibrant pops of colour throughout."
    },
    {
        id: "QE69D",
    ...
    },
    {
        ...
        type: "arrived",
        description: "Classic camo gets a fresh update with this adidas 3-Stripes Camo Tee. The design adds an \
        unexpected twist to the shoulders to bring a little diversity to your daily tee. Soft cotton makes it ready \
        for everyday comfort. Our cotton products support more sustainable cotton farming."
    }
]
